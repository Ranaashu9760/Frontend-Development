def hint_username(username):
        if len(username) < 3:
            print("Invalid username. Must be at least 3 char log")
        elif len(username)>15:
              print("Invald username. Must be at most 15 character long")
        else:
...
print()
def calculate_storage(flesize):
    block_size = 4096
    partial_block_remainder=5 
